...
% ------------ PART I: NH-Devices ------------------------------------------------------------------
\part{Non hermitian devices}
  \input{./Chapters/ChapterAsymmetricScattering}    %Asymmetric Scattering nonhermitian
  \input{./Chapters/ChapterSymAndInvariants}        %Invariants of non-h Hamiltonians
  \input{./Chapters/ChapterRealEigenValues}         %complex plane symmetries of nh Hamiltonians
  \input{./Chapters/ChapterDiscreteNNSymmetries}    %Discrete Hamiltonian symmetries
  \input{./Chapters/ChapterPhysicalImplementation}  %Physical Implementation

% ------------ PART II: Heat Rectification ---------------------------------------------------------
\part{Heat rectification in mesoscopic systems}
  \input{./Chapters/ChapterLocalRectification}      %Rectification with local impurity
  \input{./Chapters/RectificationChainOfIons}       %Rectification chain of Ions
  \input{./Chapters/ChapterToyModel}                %Rectification Toy Model
...
\input{./Appendices/Appendix_ScatteringFormalism} %Review of scattering theory formalism
\input{./Appendices/Appendix_AlternativeFormulationOfPseudoHermiticity} %Alternative formulation of $A$-pseudohermitian symmetries as ordinary (commuting) symmetries
\input{./Appendices/Appendix_SeparablePotentials} %Properties of separable potentials
\input{./Appendices/Appendix_NumericalCalculationOfTandR} %Numerical calculation of transmission and reflection coefficients
\input{./Appendices/Appendix_SteadyStateEquations} %Full set of steady-state equations for the components of $\mathbb{C}^{s.s}$
\input{./Appendices/Appendix_SpectralDensity} %Complete expressions for the Spectral Density Matrix
