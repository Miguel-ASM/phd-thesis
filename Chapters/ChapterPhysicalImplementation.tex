...
\lhead{Chapter Physical Implementation. \emph{Quantum-optical implementation of non-Hermitian potentials for asymmetric scattering}} % Write in your own chapter title to set the page header
%
...
\subsection{Free motion, ${\cal V}=0$}
%
%
...
\subsection{Asymptotic form of the solutions}
%
...
\subsection{Improving numerical efficiency}
%
...
\subsection{Bounds from unitarity}
%
The $S$-matrix
%
\begin{equation}
